...
func tstMockPunishmentProposal(bl int, pubKey interfaces.PublicKey) *PunishmentProposal {
	h0, h1 := wire.MockHeader(1, poc.ProofTypeDefault), wire.MockHeader(1, poc.ProofTypeDefault)
