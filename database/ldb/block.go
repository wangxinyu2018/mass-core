...
func (db *ChainDb) submitBlock(block *massutil.Block) (err error) {
	...
	if err = updateMinedBlockIndex(batch, true, block.MsgBlock().Header.PublicKey(), block.Height()); err != nil {
		return err
	}
...
func (db *ChainDb) deleteBlock(hash *wire.Hash) (err error) {
	...
	if err = updateMinedBlockIndex(batch, false, blk.MsgBlock().Header.PublicKey(), height); err != nil {
		return err
	}
