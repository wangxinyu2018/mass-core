...
func CalcNextRequiredDifficulty(lastHeader *wire.BlockHeader, newBlockTime time.Time, chainParams *config.Params) (*big.Int, error) {
	// Genesis block.
	if lastHeader == nil {
		return chainParams.PocLimit, nil
	}
